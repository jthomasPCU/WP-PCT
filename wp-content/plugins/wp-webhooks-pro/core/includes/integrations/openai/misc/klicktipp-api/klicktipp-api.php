...
require ("openai.api.inc"); // this file
...
class KlicktippConnector {
   ...
   */
  public function __construct($service = 'https://api.openai.com') {
...
class KlicktippPartnerConnector extends KlicktippConnector {
   ...
   * @return the connector object
   */
  public function __construct($username, $developer_key, $customer_key, $service = 'https://api.openai.com') {
